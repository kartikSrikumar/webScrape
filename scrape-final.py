...
while no_error:
    ...
    soup = BeautifulSoup(
        html, "html.parser"
    )  # convert raw html to something I can use with BeautifulSoup
    ...
    for i in range(len(items)):
        ...
        price = price.find("strong").text.replace(",", " ") + price.find("sup").text #converting this entire line to float causes an error
